  ...
  'zh-CN': {
    ...
    dialogs: {
      ...
      settings: {
        ...
        minimizeToTrayOnClose: '关闭按钮隐藏到托盘',
        minimizeToTrayOnCloseHint: '开启后，点击右上角关闭按钮会隐藏到系统托盘；最小化按钮仍会收到任务栏。',
        restartCodexAfterSwitch: '切换后自动重启 Codex',
        restartCodexAfterSwitchHint: '开启后，账号切换成功会尝试关闭并重新打开 Codex，让新配置在下一次启动时生效。',
        archivedSessionRetentionDays: '已归档对话过期时间',
        archivedSessionRetentionDaysSuffix: '天',
        archivedSessionRetentionDaysHint: '启动和刷新时会自动删除目标 Codex 目录中超过该天数的已归档对话。',
    ...
    notifications: {
      ...
      switched: '配置切换成功',
      switchedAndRestarted: '配置切换成功，已尝试重启 Codex',
      switchedRestartFailed: '配置已切换，但自动重启 Codex 失败：{error}',
      deleted: '配置已删除',
  ...
  'en-US': {
    ...
    dialogs: {
      ...
      settings: {
        ...
        minimizeToTrayOnClose: 'Hide to tray on close',
        minimizeToTrayOnCloseHint: 'When enabled, the close button hides the window to the system tray; the minimize button still goes to the taskbar.',
        restartCodexAfterSwitch: 'Restart Codex after switching',
        restartCodexAfterSwitchHint: 'When enabled, a successful switch will try to close and reopen Codex so the new config is used on the next launch.',
        archivedSessionRetentionDays: 'Archived chat expiration',
        archivedSessionRetentionDaysSuffix: 'days',
        archivedSessionRetentionDaysHint: 'On launch and refresh, archived chats older than this in the target Codex directory are deleted automatically.',
    ...
    notifications: {
      ...
      switchedAndRestarted: 'Profile switched and Codex restart was requested',
      switchedRestartFailed: 'Profile switched, but Codex restart failed: {error}',
      ...
      networkRepairCompleted: 'Network repair completed',
