import type { APIProfileInput, AppState, NetworkRepairResult, UpdateSettingsInput } from '../types';
...
interface BackendAPI {
  ...
  RepairNetwork(): Promise<NetworkRepairResult>;
...
export const backend = {
  ...
  restartCodex: () => appBridge().RestartCodex(),
  repairNetwork: () => appBridge().RepairNetwork(),
