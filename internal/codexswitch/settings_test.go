...
func TestGetSettingsDefaultsArchivedSessionRetentionDays(t *testing.T) {
	...
	if settings.ArchivedSessionRetentionDays != defaultArchivedSessionRetentionDays {
		t.Fatalf("expected default archived session retention %d, got %d", defaultArchivedSessionRetentionDays, settings.ArchivedSessionRetentionDays)
	}
}
