...
const defaultArchivedSessionRetentionDays = 30
...
func (s *Service) loadSettings() (AppSettings, error) {
	settings := AppSettings{
		...
		ArchivedSessionRetentionDays: defaultArchivedSessionRetentionDays,
	}
...
func normalizeSettings(settings *AppSettings) {
	...
	if settings.ArchivedSessionRetentionDays <= 0 {
		settings.ArchivedSessionRetentionDays = defaultArchivedSessionRetentionDays
	}
}
