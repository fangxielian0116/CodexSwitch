...
type AppSettings struct {
	...
	RestartCodexAfterSwitch      bool   `json:"restartCodexAfterSwitch"`
	ArchivedSessionRetentionDays int    `json:"archivedSessionRetentionDays"`
}
...
type UpdateSettingsInput struct {
	...
	RestartCodexAfterSwitch      *bool  `json:"restartCodexAfterSwitch,omitempty"`
	ArchivedSessionRetentionDays *int   `json:"archivedSessionRetentionDays,omitempty"`
}
